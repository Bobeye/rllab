...
n_sub_iter=pd.read_csv("n_sub_iter_hc.csv")
rewards_snapshot=pd.read_csv("rewards_snapshot_hc.csv")
rewards_subiter=pd.read_csv("rewards_subiter_hc.csv")
variance_sgd=pd.read_csv("variance_sgd_hc.csv")
variance_svrg=pd.read_csv("variance_svrg_hc.csv")
importance_weights=pd.read_csv("importance_weights_hc.csv")
