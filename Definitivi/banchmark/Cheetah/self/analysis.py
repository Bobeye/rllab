...
n_sub_iter=pd.read_csv("n_sub_iter_ba_c.csv")
rewards_snapshot=pd.read_csv("rewards_snapshot_ba_c.csv")
rewards_subiter=pd.read_csv("rewards_subiter_ba_c.csv")
variance_sgd=pd.read_csv("variance_sgd_ba_c.csv")
variance_svrg=pd.read_csv("variance_svrg_ba_c.csv")
importance_weights=pd.read_csv("importance_weights_ba_c.csv")
