...
rewards_subiter_data.to_csv("rewards_subiter_adam_reuse.csv",index=False)
rewards_snapshot_data.to_csv("rewards_snapshot_adam_reuse.csv",index=False)
n_sub_iter_data.to_csv("n_sub_iter_adam_reuse.csv",index=False)
variance_sgd_data.to_csv("variance_sgd_adam_reuse.csv",index=False)
variance_svrg_data.to_csv("variance_svrg_adam_reuse.csv",index=False)
importance_weights_data.to_csv("importance_weights_adam_reuse.csv",index=False)
