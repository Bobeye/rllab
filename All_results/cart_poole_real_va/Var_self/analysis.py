...
n_sub_iter=pd.read_csv("n_sub_iter_v2_V_sn.csv")
rewards_snapshot=pd.read_csv("rewards_snapshot_v2_V_sn.csv")
rewards_subiter=pd.read_csv("rewards_subiter_v2_V_sn.csv")
variance_sgd=pd.read_csv("variance_sgd_v2_V_sn.csv")
variance_svrg=pd.read_csv("variance_svrg_v2_V_sn.csv")
importance_weights=pd.read_csv("importance_weights_v2_V_sn.csv")
