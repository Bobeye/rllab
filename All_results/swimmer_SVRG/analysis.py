...
n_sub_iter=pd.read_csv("n_sub_iter_vA_swimmer.csv")
rewards_snapshot=pd.read_csv("rewards_snapshot_vA_swimmer.csv")
rewards_subiter=pd.read_csv("rewards_subiter_vA_swimmer.csv")
variance_sgd=pd.read_csv("variance_sgd_vA_swimmer.csv")
variance_svrg=pd.read_csv("variance_svrg_vA_swimmer.csv")
importance_weights=pd.read_csv("importance_weights_vA_swimmer.csv")
