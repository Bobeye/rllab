...
n_sub_iter=pd.read_csv("n_sub_iter_Adam_v_trunc.csv")
rewards_snapshot=pd.read_csv("rewards_snapshot_Adam_v_trunc.csv")
rewards_subiter=pd.read_csv("rewards_subiter_Adam_v_trunc.csv")
variance_sgd=pd.read_csv("variance_sgd_Adam_v_trunc.csv")
variance_svrg=pd.read_csv("variance_svrg_Adam_v_trunc.csv")
importance_weights=pd.read_csv("importance_weights_Adam_v_trunc.csv")
gpomdp_rewards=pd.read_csv("GPOMDP_AVAR_rewards_adam.csv")
