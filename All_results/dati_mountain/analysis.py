...
n_sub_iter=pd.read_csv("n_sub_iter_v2_mountain.csv")
rewards_snapshot=pd.read_csv("rewards_snapshot_vA_mountain.csv")
rewards_subiter=pd.read_csv("rewards_subiter_vA_mountain.csv")
variance_sgd=pd.read_csv("variance_sgd_vA_mountain.csv")
variance_svrg=pd.read_csv("variance_svrg_vA_mountain.csv")
importance_weights=pd.read_csv("importance_weights_vA_mountain.csv")
