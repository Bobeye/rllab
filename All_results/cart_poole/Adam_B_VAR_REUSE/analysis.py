...
n_sub_iter=pd.read_csv("n_sub_iter_adam_v_reuse.csv")
rewards_snapshot=pd.read_csv("rewards_snapshot_adam_v_reuse.csv")
rewards_subiter=pd.read_csv("rewards_subiter_adam_v_reuse.csv")
variance_sgd=pd.read_csv("variance_sgd_adam_v_reuse.csv")
variance_svrg=pd.read_csv("variance_svrg_adam_v_reuse.csv")
importance_weights=pd.read_csv("importance_weights_adam_v_reuse.csv")
