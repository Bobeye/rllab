...
n_sub_iter=pd.read_csv("n_sub_iter_swimmer_vB_3.csv")
rewards_snapshot=pd.read_csv("rewards_snapshot_swimmer_vB_3.csv")
rewards_subiter=pd.read_csv("rewards_subiter_swimmer_vB_3.csv")
variance_sgd=pd.read_csv("variance_sgd_vB_swimmer_3.csv")
variance_svrg=pd.read_csv("variance_svrg_vB_swimmer_3.csv")
importance_weights=pd.read_csv("importance_weights_vB_swimmer_3.csv")
