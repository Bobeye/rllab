...
f_update = theano.function(
    ...
    outputs = None,
    updates = adam([eval_grad1, eval_grad2, eval_grad3, eval_grad4, eval_grad5, eval_grad6, eval_grad7, eval_grad8, eval_grad9], params, learning_rate=learning_rate)
)
runs_rewards = {}
...
#        policy.set_param_values(np.loadtxt('policy.txt'), trainable=True)
    ...
    for j in range(n_itr):
        ...
        f_update(s_g[0],s_g[1],s_g[2],s_g[3],s_g[4],s_g[5],s_g[6],s_g[7],s_g[8])
...
ar_data.to_csv("ar_va_GPOMDP.csv",index=False)
