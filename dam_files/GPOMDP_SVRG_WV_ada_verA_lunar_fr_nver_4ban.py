...
for k in range(1):
    ...
    while j<s_tot-N:
        ...
        stp_snp = np.sum(f_update[0](s_g[0],s_g[1],s_g[2],s_g[3],s_g[4],s_g[5],s_g[6],s_g[7],s_g[8]))
        ...
        print(str(j-1)+' Snapshot Average Return:', np.mean(all_rew))
...
#            print("w cum: " + str(w_cum))
            ...
            print(str(j-1)+' Average Return:', np.mean(all_rew))
            stp = np.sum(f_update[1](g[0],g[1],g[2],g[3],g[4],g[5],g[6],g[7],g[8]))
            print("step:",stp)
