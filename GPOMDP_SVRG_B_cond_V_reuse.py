...
rewards_subiter_data.to_csv("rewards_subiter_Adam_v_reuse.csv",index=False)
rewards_snapshot_data.to_csv("rewards_snapshot_Adam_v_reuse.csv",index=False)
n_sub_iter_data.to_csv("n_sub_iter_Adam_v_reuse.csv",index=False)
variance_sgd_data.to_csv("variance_sgd_Adam_v_reuse.csv",index=False)
variance_svrg_data.to_csv("variance_svrg_Adam_v_reuse.csv",index=False)
importance_weights_data.to_csv("importance_weights_Adam_v_reuse.csv",index=False)