...
rewards_subiter_data.to_csv("rewards_subiter_verB_lunar.csv",index=False)
rewards_snapshot_data.to_csv("rewards_snapshot_verB_lunar.csv",index=False)
n_sub_iter_data.to_csv("n_sub_iter_verB_lunar.csv",index=False)
variance_sgd_data.to_csv("variance_sgd_verB_lunar.csv",index=False)
variance_svrg_data.to_csv("variance_svrg_verB_lunar.csv",index=False)
importance_weights_data.to_csv("importance_weights_verB_lunar.csv",index=False)

alla.to_csv("GPOMDP_SVRG_adaptive_verB_lunar.csv",index=False)