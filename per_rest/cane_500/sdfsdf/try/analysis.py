...
n_sub_iter=pd.read_csv("n_sub_iter_vA_swimmer_sn4.csv")
rewards_snapshot=pd.read_csv("rewards_snapshot_swimmer_vA_sn4.csv")
rewards_subiter=pd.read_csv("rewards_subiter_swimmer_vA_sn4.csv")
variance_sgd=pd.read_csv("variance_sgd_vA_swimmer_sn4.csv")
variance_svrg=pd.read_csv("variance_svrg_vA_swimmer_sn4.csv")
importance_weights=pd.read_csv("importance_weights_vA_swimmer_sn4.csv")
gpomdp_rewards=pd.read_csv("rewards_snapshot_GPOMDP_swimmer_sgd8.csv")
